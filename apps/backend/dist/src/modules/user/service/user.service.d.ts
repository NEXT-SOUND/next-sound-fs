...
export declare class UsersService {
    ...
    updateVerificationToken(id: string, verificationToken: string | undefined, verificationTokenExpiresAt: Date | undefined): Promise<User>;
    updateTokens(id: string, accessToken?: string, refreshToken?: string): Promise<User>;
}
